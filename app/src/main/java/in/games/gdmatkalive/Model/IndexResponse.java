...
public class IndexResponse {
  String id,  mobile,adm_email,version,app_link,share_link,message,home_text,withdraw_text,withdraw_no,tag_line,min_amount,msg_status,w_saturday,w_sunday,w_amount,withdraw_limit,min_wallet,min_wallet_msg,device_config,notice;
